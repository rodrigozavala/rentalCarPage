...
import com.project.rentalCarPage.tables.JDBCClasses.tables.Client;
...
public class ClientController {
     ...
     */
    @PostMapping(value = ViewConstants.POST_CALL_PATH_CLIENT_INFO /*"/clientInfo"*/)
    public String getUserProfile(Model model, HttpServletResponse response, HttpServletRequest request) {
        ...
        return ViewConstants.HTML_CLIENT_INFO;//"clientInfo";
    }
     ...
     * @return index.html
     */
    @GetMapping(value = ViewConstants.GET_CALL_PATH_INDEX /*"/index"*/)
    public String showMainView(Model model, HttpServletResponse response, HttpServletRequest request) {
        ...
        return ViewConstants.HTML_INDEX;//"index";
    }
     ...
     * @return SignUp.html
     */
    @GetMapping(value = ViewConstants.GET_CALL_PATH_SIGN_UP/*"/SignUp"*/)
    public String showSignUpView(Model model, HttpServletResponse response, HttpServletRequest request) {
        toolsToCustomizeNav.navCustomization(model, request, response);

        return ViewConstants.HTML_SIGN_UP;//"SignUp";
    }

    @GetMapping(value = ViewConstants.GET_CALL_PATH_CHANGE_DATA/*"/changeData"*/)
    public String showChangeDataView(Model model, HttpServletResponse response, HttpServletRequest request) {
        ...
        return ViewConstants.HTML_CHANGE_DATA;//"changeData";
    }
     ...
     * @return logout.html
     */
    @GetMapping(value = ViewConstants.GET_CALL_PATH_LOGOUT/*"/logout"*/)
    public String showLogoutView(Model model, HttpServletResponse response, HttpServletRequest request) {
        ...
        return ViewConstants.HTML_LOGOUT;//"logout";
    }
